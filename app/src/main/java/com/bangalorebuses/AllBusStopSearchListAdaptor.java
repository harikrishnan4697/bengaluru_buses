...
class AllBusStopSearchListAdaptor extends BaseAdapter implements Filterable
{
    public Activity context;
    private ArrayList<BusStop> busStops = null;
    private ArrayList<BusStop> filteredBusStops = null;
    private LayoutInflater inflater;
    private AllBusStopSearchListAdaptor.ItemFilter mFilter = new AllBusStopSearchListAdaptor.ItemFilter();

    AllBusStopSearchListAdaptor(Activity context, ArrayList<BusStop> busStops)
    {
        super();
    ...
    {
        AllBusStopSearchListAdaptor.ViewHolder holder;
        if (convertView == null)
        {
            holder = new AllBusStopSearchListAdaptor.ViewHolder();
        ...
        {
            holder = (AllBusStopSearchListAdaptor.ViewHolder) convertView.getTag();
        }
