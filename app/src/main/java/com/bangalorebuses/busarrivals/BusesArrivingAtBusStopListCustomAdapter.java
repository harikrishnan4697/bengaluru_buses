...
public class BusesArrivingAtBusStopListCustomAdapter extends BaseAdapter
{
    public Activity context;
    private ArrayList<BusRoute> busRoutes = null;
    private LayoutInflater inflater;

    public BusesArrivingAtBusStopListCustomAdapter(Activity context, ArrayList<BusRoute> busRoutes)
    {
        super();
