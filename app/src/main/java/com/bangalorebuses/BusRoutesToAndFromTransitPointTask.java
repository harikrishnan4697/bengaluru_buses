...
class BusRoutesToAndFromTransitPointTask extends AsyncTask<Void, Void, Void>
{
    ...
    BusRoutesToAndFromTransitPointTask(IndirectTripHelper caller, String originBusStopName, TransitPoint transitPoint,
    ...
    protected void onPostExecute(Void param)
    {
        ...
        caller.onRoutesToAndFromTransitPointFound(transitPoint);
    }
}